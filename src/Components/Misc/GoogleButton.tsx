...
const button = (renderProps: GoogleProps) => {
  return <button onClick={renderProps.onClick} disabled={renderProps.disabled} style={{
...
export const GoogleButton = () => {
  ...
  return (
    <>
      <GoogleLogin
        clientId="141093366027-kkd7btljdrf1j1ieg6to5rpbs0nshq20.apps.googleusercontent.com"
